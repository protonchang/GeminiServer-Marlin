...
#define MSG_CONTROLLER_FAN_SPEED            _UxGT("Geschwindigkeit")
#define MSG_CONTROLLER_FAN_AUTO_ON          _UxGT("Automodus")
#define MSG_CONTROLLER_FAN_DURATION         _UxGT("Einschalt Delay")
