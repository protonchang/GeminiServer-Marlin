 ...
 */
  ...
  #define BUILD_PREFIX "4MAX-SKR "  // x.y.zz | Count zz Up for testing Builds.
    ...
    #define BUILD_SUFFIX  "ALPHA"        // Release Tag (Rel. | Beta)
    #define BUILD_VERSION "2.0.x"    // Version Info - Major.Minor.Build Build - WXYZ
 ...
 */
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.12018, 80.10413, 397.14058, 101.72 }
#elif ENABLED(ANYCUBIC_4MAX_DEFAULT)
  // Default 4MAX
